...
class Ui_HelpDialog(object):
    def setupUi(self, HelpDialog):
        ...
        HelpDialog.resize(500, 340)
        HelpDialog.setMinimumSize(QtCore.QSize(446, 340))
        HelpDialog.setMaximumSize(QtCore.QSize(500, 340))
        self.buttonBox = QtWidgets.QDialogButtonBox(HelpDialog)
        self.buttonBox.setGeometry(QtCore.QRect(60, 300, 421, 21))
        self.buttonBox.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Close)
        self.buttonBox.setObjectName("buttonBox")
        self.label = QtWidgets.QLabel(HelpDialog)
        self.label.setGeometry(QtCore.QRect(10, 50, 451, 241))
        self.label.setMinimumSize(QtCore.QSize(0, 241))
        self.label.setMaximumSize(QtCore.QSize(16777215, 241))
